    ...
    <html lang="tr" className="h-full">
      <body className="min-h-screen bg-white text-neutral-900 dark:bg-neutral-950 dark:text-neutral-50">
        <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
          <div className="absolute inset-x-0 -top-24 h-[480px] bg-gradient-hero blur-3xl opacity-70 dark:opacity-80" />

          <div className="absolute left-1/2 top-1/2 h-[720px] w-[720px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-conic-orbit opacity-30 blur-2xl" />
